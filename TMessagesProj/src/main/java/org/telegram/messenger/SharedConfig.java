...
public class SharedConfig {
    ...
    public static class ShadowsocksRProxy extends ProxyInfo {
                    ...
                    try {
                        ...
                        if (currentProxy == null && !TextUtils.isEmpty(proxyAddress)) {
                            ...
                            if (proxyAddress.equals(info.address) && (proxyPort == info.port && proxyUsername.equals(info.username) && proxyPassword.equals(info.password) ||
                                    ...
                                    (currentProxy instanceof ShadowsocksRProxy && vmessLink.equals(((ShadowsocksRProxy) currentProxy).bean.toString())))
            ...
            try {
                ...
                for (int a = 0; a < proxyArray.length(); a++) {
                    ...
                    if (currentProxy == null && !TextUtils.isEmpty(proxyAddress)) {
                        ...
                        } else if ((info instanceof ShadowsocksRProxy && vmessLink.equals(((ShadowsocksRProxy) info).bean.toString()))) {
    ...
    public static void saveProxyList() {
        ...
        for (int a = 0; a < proxyList.size(); a++) {
            ...
            try {
                ...
                } else if (info instanceof ShadowsocksRProxy) {
                    proxyObJ.put("port", info.port);
                    proxyObJ.put("vmess_link", ((ShadowsocksRProxy) info).bean.toString());
                } else {
